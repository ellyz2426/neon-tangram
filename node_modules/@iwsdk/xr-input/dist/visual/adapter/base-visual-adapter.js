...
class XRInputVisualAdapter {
    ...
    connectVisual() {
        if (this.inputConfig) {
            ...
            XRInputVisualAdapter.createVisual(this.visualClass, inputSource, layout, this.visualsEnabled, this.scene, this.camera, this.assetLoader, this.inputConfig.assetPath).then((visual) => {
                if (visual &&
    ...
    static async createVisual(visualClass, inputSource, layout, enabled, scene, camera, assetLoader, profileAssetPath) {
        var _a, _b;
        const profileId = (_a = visualClass.assetProfileId) !== null && _a !== void 0 ? _a : inputSource.profiles[0];
        const assetPath = (_b = profileAssetPath !== null && profileAssetPath !== void 0 ? profileAssetPath : visualClass.assetPath) !== null && _b !== void 0 ? _b : `${DEFAULT_PROFILES_PATH}/${profileId}/${inputSource.handedness}.glb`;
        ...
        if (this.visualCache.has(assetKey)) {
            ...
            if (!gltf || gltf.scene.children.length === 0) {
                console.warn(`[xr-input] Failed to load visual asset ${assetPath}; input will be tracked without a visual.`);
                return undefined;
            }
