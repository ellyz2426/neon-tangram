...
import { getRequiredInputProvider } from './locomotion-input-provider.js';
...
class TeleportSystem extends createSystem({}, {
    ...
    init() {
        ...
        this.inputProvider = getRequiredInputProvider('TeleportSystem', this.config.inputProvider.value);
    ...
    update() {
        ...
        let teleportActive = this.inputProvider.getTeleportActive(pointerBusy, this.config.microGestureControlsEnabled.value);
        if (teleportActive) {
            if (!this.inputProvider.getTeleportRay(this.rayOrigin, this.rayDirection)) {
        ...
        if (teleportActive) {
            ...
            if (this.targetValid &&
                this.inputProvider.getTeleportCommit(this.config.microGestureControlsEnabled.value)) {
