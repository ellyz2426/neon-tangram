...
class SlideSystem extends createSystem({}, {
    ...
    init() {
        ...
        this.inputProvider = getRequiredInputProvider('SlideSystem', this.config.inputProvider.value);
    ...
    update(delta) {
        ...
        this.inputProvider.getMoveAxis(this.input2D);
        {
            ...
            if (inputValue > 0) {
                this.inputProvider.getMovementReferenceQuaternion(this.movementDirection);
