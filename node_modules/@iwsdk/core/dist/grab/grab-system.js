        ...
        if (this.config.useHandPinchForGrab) {
            ['left', 'right'].forEach((handedness) => {
                ...
                if (this.input.xr.isPrimary('hand', handedness)) {
                    ...
                    if ((_a = this.input.xr.gamepads[handedness]) === null || _a === void 0 ? void 0 : _a.getSelectStart()) {
                        this.input.xr.multiPointers[handedness].routeDown('squeeze', 'grab', {
                            timeStamp,
                        });
                    }
                    if ((_b = this.input.xr.gamepads[handedness]) === null || _b === void 0 ? void 0 : _b.getSelectEnd()) {
