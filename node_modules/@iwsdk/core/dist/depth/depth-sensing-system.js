...
class DepthSensingSystem extends createSystem({
    ...
    get isGPUDepth() {
        ...
        return (session === null || session === void 0 ? void 0 : session.depthUsage) === 'gpu-optimized';
    }
    getDepthTextureArray() {
        var _a, _b;
        return this.isGPUDepth
            ? (_a = this.depthTextures) === null || _a === void 0 ? void 0 : _a.getNativeTexture()
            : (_b = this.depthTextures) === null || _b === void 0 ? void 0 : _b.getDataArrayTexture();
    }
    runMinMaxPreprocessing() {
        ...
        const depthNear = (_b = (_a = this.gpuDepthData[0]) === null || _a === void 0 ? void 0 : _a.depthNear) !== null && _b !== void 0 ? _b : 0;
