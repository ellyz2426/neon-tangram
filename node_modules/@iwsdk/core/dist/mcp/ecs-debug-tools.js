...
function ecsFindEntities(world, params) {
    ...
    for (let i = 0; i < lookup.length; i++) {
        ...
        const componentIds = entity.getComponents().map((c) => c.id);
        matches.push({
            entityIndex: entity.index,
...
function getEntityDebugSortRank(entity) {
