...
import { System as ElicsSystem, Query, SystemConstructor, SystemQueries, SystemSchema, TypeValueToType } from 'elics';
import type { QueryManager } from 'elics/lib/query-manager.js';
import type { InputManager } from '../input/index.js';
import { PerspectiveCamera, Scene, WebGLRenderer, WebXRManager } from '../runtime/index.js';
 ...
 * @category ECS
 */
export interface System<S extends SystemSchema, Q extends SystemQueries> extends ElicsSystem<S, Q> {
    isPaused: boolean;
 ...
 * @category ECS
 */
export declare function createSystem<S extends SystemSchema, Q extends SystemQueries>(queries?: Q, schema?: S): SystemConstructor<S, Q, World, System<S, Q>>;
export {};
