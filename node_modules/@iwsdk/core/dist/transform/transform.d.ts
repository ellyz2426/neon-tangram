 ...
 * @hideineditor
 */
export declare const Transform: import("elics").Component<{
    position: {
        type: Types.Vec3;
...
declare const TransformSystem_base: import("elics").SystemConstructor<import("elics").SystemSchema, {
    transform: {
 ...
 * @category Scene
 */
export declare class TransformSystem extends TransformSystem_base {
    init(): void;
    update(): void;
}
export {};
